...
import type { IReadOnlyFormCollection } from "react-model-view-viewmodel";
import { type IHintKeepReadOnlyFormCollection, HintKeepReadOnlyFormCollection } from "./HintKeepReadOnlyFormCollection";

export interface IHintKeepFormCollection extends IReadOnlyFormCollection<HintKeepForm>, IHintKeepReadOnlyFormCollection {
}

export class HintKeepFormCollection extends HintKeepReadOnlyFormCollection implements IHintKeepFormCollection {
    /**
