...
{
    public class MoveAccountToBinCommandHandler : IRequestHandler<MoveAccountToBinCommand>
    {
        ...
        public async Task Handle(MoveAccountToBinCommand command, CancellationToken cancellationToken)
        {
