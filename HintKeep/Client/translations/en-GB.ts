...
export const enGB: IMessages = {
    ...
    'pages.passwordReset.email.label': 'E-Mail Address',
    'pages.passwordReset.email.placeholder': 'user@email.com',
    ...
    'pages.terms.lastModified': 'Last modified: 25th February, 2022',
    ...
    'pages.terms.list.1.item.1': 'We reserve the right to make any changes to the terms of service, at any moment with the condition that your data will be always protected. In no way, shape or form future changes impact the security of your data and of your account. The only changes are either clarifications, either improved security considerations.',
    'pages.terms.list.1.item.2': 'We reserve the right to shut down the website, a 30-day notice will be displayed on the application itself prior to doing this so that you have access to your data and save it.',
    'pages.terms.list.1.item.3': 'The e-mail address is used exclusively to send notifications when registering and when performing account maintenance actions. In all cases when an e-mail is being sent the e-mail address is requested, but it is never stored in plain text in our database for security considerations.',
