        ...
        <div className={Style.mx3}>
            ...
            <BusyContent $vm={$vm}>
                ...
                <div className={Style.mb3}>
                    <button type="button" disabled={(($vm.form.isInvalid && $vm.form.areAllFieldsTouched) || !$vm.form.termsOfServiceAcceptance.value)} className={classnames(Style.btn, Style.btnPrimary)} onClick={() => $vm.submitAsync()}>
